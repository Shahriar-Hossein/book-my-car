...
<body class="d-flex flex-column min-vh-100">
  ...
  <div class="container flex-grow-1 mt-4">
    ...
    <div class="row">
      <div class="col-lg-6">
        <img class="img-fluid rounded mb-4" src="vendor/img/super-car.jpg" alt="">
      </div>
      <div class="col-lg-6">
        <h2>About Us</h2>
        <p>
            Car Rental System is a system build to deal with problems faced in
            ...
            maintenance of the vehicles in terms of finance and time consumption.Car Rental System 

...
<!--End Navigation-->
  ...
  <div class="container flex-grow-1 mt-4">
    <div class="container">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item" style="background-image: url('vendor/img/red-car-1.jpg')">
          </div>
          ...
          <div class="carousel-item" style="background-image: url('vendor/img/super-car.jpg')">
          </div>
        </div>
    ...
    <h1 class="my-4">Welcome to Car Rental System</h1>
